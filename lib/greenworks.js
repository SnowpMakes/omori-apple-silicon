...
// Patched for OMORI on arm64 by SnowpMakes and ynx0

require("./node-polyfill-patch"); // Node polyfill injection point
...
if (process.platform == 'darwin') {
  ...
  else if (process.arch == 'arm64') // Should only ever reach this branch
